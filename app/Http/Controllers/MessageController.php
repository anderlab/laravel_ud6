...
class MessageController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $userfrom=User::find($message->from);
          ...
          return view('message.show')->with('message', $message)->with('name',$userfrom->user)->with('responder','0');
    }
    ...
    public function response($id)
    {
        ...
        $userfrom=User::find($message->from);
          ...
          return view('message.show')->with('message', $message)->with('name',$userfrom->user)->with('responder','1');
    }
    ...
    public function edit($id)
    {
      ...
      return view('message.edit')->with('message', $message)->with('name',$userfrom->user);
    }
